 ...
 *
 * useFloor=true  → Math.floor (room temps: matches Kumo app's truncation of sensor readings)
 * useFloor=false → Math.round (setpoints: recovers original °F from API's 0.5°C quantisation)
 */
